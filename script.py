...
<body>
  ...
  <main>
    <section class="intro">
      ...
      <p class="intro-sub">
        這個頁面整理 PubMed 上「標題包含 sulforaphane」的最新論文，並將英文摘要轉寫成一般人也看得懂的中文解說。
        你可以用下方的「研究類型」勾選篩選，只看人類研究、動物研究、臨床試驗或特定疾病相關的研究。
      </p>
      ...
      filtered.forEach(item => {
        ...
        card.innerHTML = `
          ...
          <div class="paper-meta">
            ...
            ${
              source
                ? `<span>·</span><span class="meta-source">論文出處：${source}</span>`
                : ''
            }
          </div>
